...
echo ""
echo -e "  ${YELLOW}2.${NC} Configure your pipeline:"
echo -e "     ${GREEN}nano config.yaml${NC}"
echo -e "     ${CYAN}Tip: Use HuggingFace repo name (e.g., openslr/librispeech_asr)${NC}"
echo -e "     ${CYAN}     OR local path (e.g., ./datasets/my_dataset) - auto-detected!${NC}"
echo ""
echo -e "  ${YELLOW}3.${NC} ${BOLD}Optional:${NC} Login to HuggingFace (only for HF datasets/upload):"
echo -e "     ${GREEN}git config --global credential.helper store${NC}"
echo -e "     ${GREEN}hf auth login${NC}"
echo ""
echo -e "  ${YELLOW}4.${NC} Run the pipeline:"
echo -e "     ${GREEN}uv run main.py${NC}"
echo -e "     ${CYAN}For ROCm (to disable warnings): ${GREEN}MIOPEN_LOG_LEVEL=3 uv run main.py${NC}"
echo ""
